...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/sembako.png" style="width: 100%;  height: 650px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #DAA520; border-bottom: 2px solid#DAA520;">Toko ini adalah tempat berjualan kami yang menyediakan macam - macam bahan pokok, didirikan tahun 2022. Kami siap mengantar dan bayar ketika pesanan datang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #DAA520; margin-top: 80px;"><b>Produk Kami</b></h2>
